    ...
    <div class="container">
        ...
        <div class="row">
          ...
          <header id="banner" class="body">
                  <h1><a href="/">少即是多... <strong></strong></a></h1>
          </header><!-- /#banner -->
        ...
        <div class="eleven columns">
                 <ol id="post-list">
                        <li><article class="hentry">
                                <header> <h2 class="entry-title"><a href="/sometools.html" rel="bookmark" title="Permalink to 一些实用工具">一些实用工具</a></h2> </header>
                                <footer class="post-info">
                                    <abbr class="published" title="2016-05-25T00:00:00+02:00"> 2016年05月25 </abbr>
                                    <address class="vcard author">posted by
                                    <!-- <a class="url fn" href="#"> dav</a> -->
                                    dav
                                    </address>
                                </footer><!-- /.post-info -->
                                <div class="entry-content"> <p><strong>1，在线文本编辑器</strong></p>
<p>&emsp;&emsp;<a href="./edit.html">编辑器</a></p>
<p><strong>1，iOS block定义语法</strong></p>
<p>&emsp;&emsp;<a href="http://fuckingblocksyntax.com/">fuckingblocks</a></p> </div><!-- /.entry-content -->
                                ...
                                <div class="row tag-row">
                                        <span>Tagged as : </span>
                                            <a class="danger label" href="/tag/tools.html">tools</a>
                                </div>
                        ...
                        <li><article class="hentry">
                                <header> <h2 class="entry-title"><a href="/fuckingblocks.html" rel="bookmark" title="Permalink to iOS block定义">iOS block定义</a></h2> </header>
                                <footer class="post-info">
                                ...
                                <div class="entry-content"> <h2>How Do I Declare A Block in Objective-C ...</h2> </div><!-- /.entry-content -->
                        ...
                        <li><article class="hentry">
                                <header> <h2 class="entry-title"><a href="/ios-mac-tools.html" rel="bookmark" title="Permalink to iOS mac工具集">iOS mac工具集</a></h2> </header>
                                <footer class="post-info">
...
<h4>1，Evernote</h4>
<p>大名鼎鼎的印象笔记，功能强大；</p>
<h4>2，SourceTree ...</h4> </div><!-- /.entry-content -->
                        ...
                        <li><article class="hentry">
                                <header> <h2 class="entry-title"><a href="/custom-xcode-remove-a-line-with-python.html" rel="bookmark" title="Permalink to xcode自定义“删除一行”快捷键的python脚本">xcode自定义“删除一行”快捷键的python脚本</a></h2> </header>
                                <footer class="post-info">
                                ...
                                <div class="entry-content"> <p>一个xcode自定义“删除一行”快捷键的python脚本</p>
<div class="highlight"><pre><span></span><span class="c1"># -*- coding:utf8 -*-</span>
<span class="c1">#</span>
<span class="c1"># 修改文件权限</span>
<span class="c1"># 添加自定义的ctr+D删除到xcode中 ...</span></pre></div> </div><!-- /.entry-content -->
                        ...
                        <li><article class="hentry">
                                <header> <h2 class="entry-title"><a href="/ios7-background-modes.html" rel="bookmark" title="Permalink to iOS 7新增三种后台测试">iOS 7新增三种后台测试</a></h2> </header>
                                <footer class="post-info">
...
某个视频类app中，一个上班族用户正在追某个感兴趣的视频，TA想每天下班回家后，TA追的那些个视频，在他上班期间已经下载完成了，TA回到家后不用下载了，直接可以看了 ...</p> </div><!-- /.entry-content -->
                        ...
                        <li><article class="hentry">
                                <header> <h2 class="entry-title"><a href="/iOS-bugs.html" rel="bookmark" title="Permalink to iOS开发-这几天遇到的问题">iOS开发-这几天遇到的问题</a></h2> </header>
                                <footer class="post-info">
...
<h4>1，ios <Error>: ImageIO: CGImageReadCreateDataWithMappedFile  'open' failed ...</error></h4> </div><!-- /.entry-content -->
                        ...
                        <li><article class="hentry">
                                <header> <h2 class="entry-title"><a href="/ReactiveCocoa-learning.html" rel="bookmark" title="Permalink to 响应式编程ReactiveCocoa学习">响应式编程ReactiveCocoa学习</a></h2> </header>
                                <footer class="post-info">
                                ...
                                <div class="entry-content"> <p>ReactiveCocoa是一个将函数响应式编程范例带入Objective-C的开源库。由Josh Abernathy和Justin Spahr-Summers在对GitHub for Mac的开发过程中建立。上周，<a href="https://github.com/ReactiveCocoa/ReactiveCocoa">ReactiveCocoa ...</a></p> </div><!-- /.entry-content -->
                        ...
                        <li><article class="hentry">
                                <header> <h2 class="entry-title"><a href="/UIBarButtonItem-all-types.html" rel="bookmark" title="Permalink to UIBarButtonItem 所有系统样式(ios_8)">UIBarButtonItem 所有系统样式(ios_8)</a></h2> </header>
                                <footer class="post-info">
                                ...
                                <div class="entry-content"> <p>2015-02-04-UIBarButtonItem-all-types</p>
<p>UIBarButtonItem 所有系统样式(ios_8)，有图有真相</p>
<p><img alt="img" src="../images/2015年2月4日下午6.02.40.png" /></p> </div><!-- /.entry-content -->
                        ...
                        <li><article class="hentry">
                                <header> <h2 class="entry-title"><a href="/ios-third-libs-arrange.html" rel="bookmark" title="Permalink to iOS开发中用到的开源库（整理）">iOS开发中用到的开源库（整理）</a></h2> </header>
                                <footer class="post-info">
...
<p>做iOS也有几年了，整理一下开发中常用到的开源库 ...</p> </div><!-- /.entry-content -->
                        ...
                        <li><article class="hentry">
                                <header> <h2 class="entry-title"><a href="/ios-encode.html" rel="bookmark" title="Permalink to iOS 中常用的字符串加密方式">iOS 中常用的字符串加密方式</a></h2> </header>
                                <footer class="post-info">
...
<div class="highlight"><pre><span></span><span class="p">-</span> <span class="p">(</span><span class="bp">NSString</span> <span class="o">*</span><span class="p">)</span><span class="nf">getMd5_16Bit_String:</span><span class="p">(</span><span class="bp">NSString</span> <span class="o">*</span><span class="p">)</span><span class="nv">srcString</span><span class="p">{</span>
    ...
    <span class="bp">NSString</span> <span class="o">*</span><span class="n">md5_32Bit_String ...</span></pre></div> </div><!-- /.entry-content -->
...
<ul class="blank">
		...
		<li><a href="/category/qi-ta.html">其它</a></li>
...
<h4>标签</h4>
	<ul class="blank">
	    ...
	    <li class="tag-1"><a href="/tag/ios.html">iOS</a></li>
	    <li class="tag-3"><a href="/tag/xcode.html">xcode</a></li>
	    <li class="tag-4"><a href="/tag/iosda-bao.html">iOS打包</a></li>
	    <li class="tag-4"><a href="/tag/tools.html">tools</a></li>
	    <li class="tag-4"><a href="/tag/githubio.html">github.io</a></li>
...
<p class="paginator">
    Page 1 / 2
        <a href="/index2.html"><i class="icon-arrow-right"></i></a>
</p>
</section><!-- /#content -->
